      ...
      <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-black dark:text-white ">
        <div className="container mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              <h1 className="text-2xl  text-gray-800 dark:text-white capitalize">
            ...
            <div className="relative w-full md:w-64">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 text-sm py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                value={searchTerm}
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <a
                      ...
                      className="ml-1 text-xs font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white capitalize"
                    >
              ...
              {filteredTopics.length > 0 ? (
                filteredTopics.map((topic, index) => (
                  <motion.div
                    ...
                    whileHover="hover"
                    className="relative rounded-xl w-fit overflow-hidden shadow-sm transition-all duration-200"
                  >
                    <a
                      href={topic.link}
                      className={`block h-full bg-white dark:bg-zinc-800 text-white`}
                    >
                      <div className="py-3 px-6 h-full items-center flex gap-2">
                        <IoFolderOpen size={24} className="text-yellow-500" />
                        <div className="flex flex-col">
                          <div className="flex justify-between items-start">
                            <h2 className="text-xs md:text-sm text-black dark:text-white">
                              {topic.title}
                            </h2>
                          </div>
                        </div>
