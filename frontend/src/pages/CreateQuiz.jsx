            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-900/30 border border-amber-200 dark:border-amber-800/50 rounded-lg p-4 flex items-start gap-4">
                ...
                <div>
                  ...
                  <button onClick={() => navigate("/plans")} className="mt-3 text-xs bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-4 py-2 rounded-md md:text-sm font-medium shadow-sm transition-all duration-200">
