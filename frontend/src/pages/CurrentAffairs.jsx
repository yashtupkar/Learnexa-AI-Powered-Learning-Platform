...
//               />
//               <div className="absolute bottom-0 left-0 right-0 z-20  px-4 py-8 md:p-12 text-white">
//                 <span className="inline-block px-3 py-1 bg-blue-600 rounded-full text-sm mb-4">
//                   {topNews[currentSlide]?.category}
//                 </span>
//                 <h1 className="text-2xl md:text-4xl  mb-4 line-clamp-2">
//                   {topNews[currentSlide]?.title}
//                 </h1>
...
//                 }}
//                 placeholder="Search Current Affairs..."
//                 className="w-full p-4 pl-12 text-lg rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-red-500/30 focus:border-red-500 shadow-xl dark:text-white transition-all"
//               />
//               <Search
...
//         {/* Rest of your existing code for categories, news grid, and pagination */}
//         <div className="container max-w-6xl mx-auto px-4 py-4">
//           <div className="flex flex-wrap justify-center gap-2">
//             {categories.map((category) => (
//               <button
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors duration-300">
        ...
        {/* News Grid */}
        <main id="all-news" className="container mx-auto px-0 sm:px-4 py-8">
          {" "}
          {loading ? (
            <NewsGridSkeleton />
          ) : currentItems.length === 0 ? (
