  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Interview Routes: InterviewLayout provides context to all child routes.
            Session route has no main Layout. Setup and Result have main Layout. */}
        ...
        <Route element={<Layout><Outlet /></Layout>}>
          ...
          <Route path="/video/:videoId" element={<StudyTube />} />
