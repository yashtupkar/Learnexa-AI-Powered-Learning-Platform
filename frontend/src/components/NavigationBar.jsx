...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 backdrop-blur-lg bg-white/30 dark:bg-black/30 z-50 transition-all duration-300 border-b border-white/50 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo Section */}
          <div className="flex gap-2 items-center">
