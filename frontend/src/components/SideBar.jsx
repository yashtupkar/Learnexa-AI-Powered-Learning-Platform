...
export function SidebarItem({
    ...
    return (
      <div className="w-full">
        <button
          ...
          className={`w-full flex items-center space-x-3 px-3 py-2.5 cursor-pointer rounded-lg transition-all duration-300 ${isActive && !upgrade
  ...
  return (
    <NavLink
      ...
      onClick={handleClick}
      className={({ isActive }) =>
        `w-full flex items-center space-x-3 px-3 py-2.5 cursor-pointer rounded-lg transition-all duration-300 ${upgrade
          ? upgradeClasses
          : isActive
            ? "bg-indigo-50 dark:bg-gradient-to-br dark:from-indigo-600 dark:to-indigo-400 text-indigo-600 dark:text-indigo-100 shadow-sm"
            : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/50"
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col">
          {/* Header */}
          <div
            className={`px-4 py-3 ${isCollapsed ? "flex-col gap-2" : "flex-row"
          ...
          >
            ...
            {!isMobile && (
              <button
                ...
                className={`text-gray-400 ${isCollapsed && "hidden"
          ...
          {/* Footer */}
          <div
            className={`p-4 border-t border-gray-100 dark:border-gray-700/50 ${isCollapsed ? "flex justify-center" : ""
              }`}
          >
            {!isCollapsed ? (
